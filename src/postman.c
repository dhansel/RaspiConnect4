...
static volatile unsigned int *MAILBOX0STATUS = (unsigned int *) (MAPPED_REGISTERS_BASE + 0xB898);
static volatile unsigned int *MAILBOX0READ   = (unsigned int *) (MAPPED_REGISTERS_BASE + 0xB880);
static volatile unsigned int *MAILBOX0WRITE  = (unsigned int *) (MAPPED_REGISTERS_BASE + 0xB8A0);
